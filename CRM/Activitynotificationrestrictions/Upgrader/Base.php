 ...
 */
class CRM_Activitynotificationrestrictions_Upgrader_Base {

  /**
   * @var CRM_Activitynotificationrestrictions_Upgrader_Base
   */
   ...
   *
   * ```
   * CRM_Activitynotificationrestrictions_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Activitynotificationrestrictions_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
